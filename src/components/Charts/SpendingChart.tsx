...
const SpendingChart: React.FC<SpendingChartProps> = ({ 
  ...
  const trendData = calculateTrendData(filteredTransactions);
    ...
    <div className="card">
      <div className="mb-4">
        ...
        <p className="text-sm text-gray-600">
          {type === 'line' 
            ? 'Shows cumulative balance over time with trend analysis'
      ...
      <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
        <div className="p-3 bg-gray-50 rounded-lg">
          ...
          <p className="font-semibold text-gray-900">{state.transactions.length}</p>
        </div>
        <div className="p-3 bg-gray-50 rounded-lg">
